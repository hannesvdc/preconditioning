...
# Turns out: WARM-UP is really important to improve performance of MPS
# This may not be necessary for NN training because warm-up will happen
# during ther first few epochs.
device = "mps"
