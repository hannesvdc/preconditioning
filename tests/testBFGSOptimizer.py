...
def quadraticTest3d():
    ...
    optimizer = bfgs.BFGSOptimizer(f, df, scheduler=scheduler.ConstantScheduler(learning_rate=0.01))
    tolerance = 1.e-12

    x0 = np.zeros(3)
    xs = optimizer.optimize(x0, tolerance=tolerance)
